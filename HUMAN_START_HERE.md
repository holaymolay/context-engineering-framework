...
```text
You are to incorporate this CERES governance orchestrator, located at https://github.com/holaymolay/governance-orchestrator, as the governance framework for this project.
